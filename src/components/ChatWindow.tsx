  ...
  return (
    <div className="absolute inset-0 z-40 flex items-stretch justify-center bg-slate-900/10">
      <div className="flex h-full w-full max-w-xl flex-col overflow-hidden rounded-[28px] bg-white shadow-2xl">
        ...
        <div className="dora-chat-scroll flex-1 space-y-4 overflow-y-auto px-5 py-5">
        ...
        <div className="dora-chat-composer-wrap border-t border-slate-200/80 bg-white/98 px-4 pb-3 pt-3 backdrop-blur-sm">
